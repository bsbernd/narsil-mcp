...
The presets above tune which **tools** are exposed. The example below instead
demonstrates the `profiles:` block — named, `--profile`-selectable groups of
repositories with per-repo and per-group backend tuning.
